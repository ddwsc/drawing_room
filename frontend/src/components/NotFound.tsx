export default function NotFound() {
	return (
		<section className="w-full h-full min-h-screen bg-gray-900 flex justify-center items-center">
			<div className="py-8 px-4 mx-auto max-w-screen-xl">
				<div className="mx-auto max-w-screen-sm text-center">
					<h1 className="mb-4 text-7xl tracking-tight font-extrabold text-primary-500">
						404
					</h1>
